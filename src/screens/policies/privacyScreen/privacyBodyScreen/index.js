export default function PrivacyBodyScreen(){
    return (
        <article className='p-5 m-3 bg-cm-grey shadow'>
            <div>
                <p>A sua privacidade é importante para nós. É política do <b className='text-cm-primary'>rafaeldevcode</b> respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <b className='text-cm-primary'>rafaeldevcode</b>, e outros sites que possuímos e operamos.</p>
                ...
                <h4>Política de Cookies rafaeldevcode</h4>
                ...
                <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o <b className='text-cm-primary'>rafaeldevcode</b> oferece no site e com caráter enunciativo, mas não limitativo:</p>
                ...
                <ul className='cm-list'>
                    ...
                    <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do <b className='text-cm-primary'>rafaeldevcode</b>, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li>
                </ul>
