...
export default function Notifications({ notifications }){
    return (
        <div id="notifications" className='position-fixed bottom-0 end-0 notification border border-cm-primary bg-cm-light p-2 rounded w-100'>
            <button title="Abrir notificações" onClick={oppenNotifications} className='border border-cm-secondary notification-btn position-absolute bg-cm-primary end-0 rounded-circle p-1 d-flex justify-content-center align-items-center'>
