...
export default function InputPass({ label, name, value, ...props }){
    return (
        <div className='d-flex flex-column position-relative my-4'>
            <i className='bi bi-lock-fill position-absolute m-2' />
            <input className='form-control ps-4 py-2 validit-custom' type='password' name={name} id={name} defaultValue={value} {...props}/>
